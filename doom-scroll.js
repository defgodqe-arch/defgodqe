/* defgodqe — Doom Scroll: videos only, no overlay UI */
(function(){
'use strict';
...
.df-doom-card{height:100dvh;width:100%;scroll-snap-align:start;scroll-snap-stop:always;background:transparent}
.df-doom-player{position:fixed!important;inset:0!important;width:100vw!important;height:100dvh!important;display:flex!important;align-items:center!important;justify-content:center!important;z-index:99991!important;background:#000!important;pointer-events:none!important}
#dfDoomPlayer{display:block!important;width:100vw!important;height:100dvh!important;min-width:0!important;min-height:0!important;border:0!important;background:#000!important;box-shadow:none!important;pointer-events:auto!important;visibility:visible!important;opacity:1!important}
...
overlay.innerHTML='<div id="dfDoomFeed"></div>';
document.body.appendChild(overlay);
const feed=overlay.querySelector('#dfDoomFeed');

// Invisible snap targets. No titles, buttons, counters, labels, or other UI are shown.
...
feed.addEventListener('scroll',()=>{
 ...
 scrollRaf=requestAnimationFrame(()=>{
   scrollRaf=0;
   if(!isOpen)return;
   const i=Math.max(0,Math.min(VIDEO_COUNT-1,
     Math.round(feed.scrollTop/Math.max(1,innerHeight))
   ));
...
document.addEventListener('keydown',e=>{
 ...
 if(e.code==='Space'){e.preventDefault();userPlay()}
});
